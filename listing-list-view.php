					...
					<div class="row">
						<div class="col-sm-9">
							<div class="listings">
								<div class="heading clearfix">
									...
									<div class="view">
										<a href="listing-list-view.php" class="active"><i class="fa fa-th-list"></i></a>
										<a href="listing-grid-view.php"><i class="fa fa-th"></i></a>
									</div> <!-- end .view -->
								...
								<div class="listings-list clearfix">
									<div class="listing">
										<div class="image" style="background-image: url('images/listing02.jpg');"></div>
										<div class="details">
										...
										<div class="content">
											...
											<div class="title"><a href="details.php">Ferrari <span>[ Grand ]</span></a></div>
											...
											<a href="details.php" class="button border">View Detials</a>
											<div class="price">$80000 <span>/ for sale</span></div>
										</div> <!-- end .content -->
									</div> <!-- end .listing -->
									<div class="listing">
										<div class="image" style="background-image: url('images/listing03.jpg');"></div>
										<div class="details">
											<div class="item"><span>4</span><i class="icon-car-seat"></i></div>
											<div class="item"><span>gas</span><i class="icon-car-fuel"></i></div>
											<div class="item"><span>sport</span><i class="icon-car-door"></i></div>
									...
									<div class="listing">
										<div class="image" style="background-image: url('images/listing04.jpg');"></div>
										<div class="details">
											<div class="item"><span>4</span><i class="icon-car-seat"></i></div>
											<div class="item"><span>gas</span><i class="icon-car-fuel"></i></div>
											<div class="item"><span>sport</span><i class="icon-car-door"></i></div>
						...
						<div class="col-sm-3">
							...
							<div class="call-to-action sidebar-cta">
								<div class="image"><img src="images/cta2.jpg" alt="alt" class="img-responsive"></div>
								<div class="content">
									<h4>Sell your Car</h4>
									<p>Submit detail and sell it Nam liber tempor cum soluta nobis eleife option congue nihil…</p>
									<a href="add-car-details.php" class="button border white">Submit Car</a>
								</div> <!-- end .content -->
